...
$(function(){
   ...
   //$('#saludo').on('click',function(){
       peticion('https://swapi.co/api/species/')
       .then(function(data){
          //var peliculas=
           console.log(data);
          ...
          var imagenesPelis=['https://bit.ly/2NbCv3w','https://bit.ly/2nJjj2n','https://bit.ly/2NLpfYC','https://bit.ly/2xNvAIW','https://bit.ly/2Qj2esY','https://bit.ly/2xZ2uWn','https://bit.ly/2Qh7zB4','https://bit.ly/2Okcvrv','https://bit.ly/2NgaQTY','https://bit.ly/2xk7pld']
              
        // console.log(imagenesPelis);

           var cTable = document.getElementById('cuerpoTabla');
           var auxT = "";
           especie.results.forEach(function(especie,index){
              
           var x=(imagenesPelis[index]);
          
          

                auxT += "<tr><td>"+especie.name+"</td><td>"+especie.language+"</td><td>"+especie.eye_colors+"</td><td>"+especie.classification+"</td><td>"+ `<img id="img3" src='${x}'  align="center" />` +"</td><td>"+index +"</td><tr>";
