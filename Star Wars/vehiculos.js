...
$(function(){
   ...
   //$('#saludo').on('click',function(){
       peticion('https://swapi.co/api/vehicles/')
       .then(function(data){
          //var peliculas=
           console.log(data);
          ...
          var imagenesPelis=['https://bit.ly/2DDzLfL','https://bit.ly/2xJr4LQ','https://bit.ly/2xUZURj','https://bit.ly/2I9gOjk','https://bit.ly/2NNDWKB','https://bit.ly/2xYb5Zt','https://bit.ly/2qZSCbo','https://bit.ly/2QgjdvM','https://bit.ly/2R8gzJW','https://bit.ly/2xKzQci']
              
        // console.log(imagenesPelis);

           var cTable = document.getElementById('cuerpoTabla');
           var auxT = "";
           vehiculos.results.forEach(function(vehiculos,index){
              
           var x=(imagenesPelis[index]);
          
          

                auxT += "<tr><td>"+vehiculos.name+"</td><td>"+vehiculos.model+"</td><td>"+vehiculos.passengers+"</td><td>"+vehiculos.cargo_capacity+"</td><td>"+ `<img id="img3" src='${x}'  align="center" />` +"</td><td>"+index +"</td><tr>";
